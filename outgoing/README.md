...
- Built assets include Tailwind CSS in `dist/assets/index-*.css` — check the build artifact size and Playwright screenshots if a failure occurs.

If you'd like, I can try to open the PR if you provide push access (or an authenticated GH token). Otherwise, hand this bundle/patch to a maintainer and they can push and create the PR.
